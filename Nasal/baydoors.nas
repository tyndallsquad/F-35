...
var switch = props.globals.getNode("sim/model/daVinci_F-35B/controls/baydoors/baydoors-switch", 1);
...
var cockpit_state = func {
	var switch = getprop("sim/model/daVinci_F-35B/controls/baydoors/baydoors-switch");
	if ( switch == 1 ) {
