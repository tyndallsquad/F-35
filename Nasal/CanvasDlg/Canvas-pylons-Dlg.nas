var showPylonsDlg = func{
	if(getprop("/payload/armament/msg")){
		if(getprop("/gear/gear/compression-ft")<0.01){
			screen.log.write("Damage is ON, Land the aircraft to change the loadout!",1,0,0);
			return;
		}
	}
...
Acversion.setText("F-35A v2        This is still experimental. Dont add any R-XXX Missiles        Made by Yanes Bechir 2016");
